  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-gradient-hero text-white hover:opacity-90 glow-primary transform hover:scale-105 transition-bounce",
        success: "bg-gradient-success text-white hover:opacity-90 glow-success",
        mind: "bg-gradient-primary text-white hover:opacity-90",
        money: "bg-warning text-warning-foreground hover:bg-warning/90",
        mastery: "bg-gradient-secondary text-white hover:opacity-90",
      },
      size: {
